...
\cvitem{H-index}{ = 20, 10000+ citations}
...
\begin{description}
  ...
  \item[2018(-2010)] \textit{Bob} - Bob is a signal-processing and machine
  ...
  \item[2018(-2012)] \textit{BEAT} - The BEAT platform is a European computing
    e-infrastructure for Open Science.  The source code for the whole platform
    is distributed through an open-source license and maintained to date.  I'm
    one of BEAT's main authors and architect.  A complete list of software
    packages can be browsed from: \url{https://gitlab.idiap.ch/beat}.
